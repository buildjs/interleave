...
exports.gcode = exports.googlecode = function(interleaver, current, target, rawTarget, callback) {
    ...
    exports.http(interleaver, current, realTarget, rawTarget, callback);
};
...
exports.block = function(interleaver, current, target, rawTarget, callback) {
    var realTarget = url.parse('github://' + target.host + '/blockstore' + target.path);
    
    exports.github(interleaver, current, realTarget, rawTarget, callback);
};
